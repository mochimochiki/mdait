...
- `design.md`を参照し、現在の設計から関連する事項を確認し、設計を行ってください。
- 大きな設計変更や新機能については適宜`design.md`を修正してください。設計の方針や骨子を重視し細部について記載しすぎないように。設計の変更はユーザーに承認を得てから行ってください。
- `design.md`の詳細設計は、`tasks/do/<作業名>.md`に作業チケットとして記載してください。おおむね100行以内・2000文字以内で。
