...
- [x] design/配下の全ファイルをdocs/に移動
- [x] design/フォルダを削除
- [x] docs/architecture.md を新設
- [x] 全設計書の内容を編集・改善
- [x] コードベース内の参照を更新（README等）
- [x] _index.md のリンクパスを更新

## 7. 品質要件チェック

- [x] 全設計書がdocs/に移動済み
- [x] user-guideが維持されている
- [x] 参照リンクが正しい
- [x] architecture.mdの品質確認

## 8. まとめと改善提案

設計書の一本化により、ドキュメント構造が明確になった。architecture.mdが設計哲学の中心として機能し、各設計書がそこからの「設計意図」を参照する形に整理された。今後は設計書の更新時にarchitecture.mdとの整合性を意識することが重要。
