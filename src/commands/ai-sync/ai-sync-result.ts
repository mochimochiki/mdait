 ...
 * @module commands/ai-sync/ai-sync-result
 */
...
export interface AiSyncOutcome {
 ...
 */
export function generateAiSyncReportContent(outcome: AiSyncOutcome): string {
 ...
 */
export function buildAiSyncNextActions(outcome: AiSyncOutcome, agg: ReviewAggregate = aggregateReviewResults(outcome.review)): string[] {
